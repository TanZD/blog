$(function(){
	...
	function getListYearMonth(){
		$.ajax({
			url:"http://106.14.135.196:8080/Blog/article/listByYearAndMonth/user/"+user_id,
			dataType:"JSON",
			xhrFields:{
	...
	function getCategory(){
		$.ajax({
			url:"http://106.14.135.196:8080/Blog/category/getFromUser/"+user_id,
			dataType:"JSON",
			xhrFields:{
				withCredentials:true
			},
	...
	function show_detail(){
		...
		$("#user_image").attr("src","http://106.14.135.196:8080/"+user_data["image"]);
		...
		layui.use('form', function(){
		  form = layui.form;
	  		...
	  		form.on('submit(formDemo)', function(data){
			    ...
			    $.ajax({
			    	url:"http://106.14.135.196:8080/Blog/user/update",
			    	data:formData,
			    	type:"POST",
			    	dataType:"JSON",
					xhrFields: {
	...
	//获取用户信息
	$.ajax({
		url:"http://106.14.135.196:8080/Blog/user/"+user_id,
		dataType:"JSON",
		success:function(data){
			console.log(data)
			if(data["code"]==1){
